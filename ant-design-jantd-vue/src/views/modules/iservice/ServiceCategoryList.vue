<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('服务分类')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <serviceCategory-modal ref="modalForm" @ok="modalFormOk"></serviceCategory-modal>
  </a-card>
</template>

<script>
  import ServiceCategoryModal from './modules/ServiceCategoryModal'
